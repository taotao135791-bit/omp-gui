...
const CREDENTIAL_ENV_RE =
  /^(ANTHROPIC|OPENAI|GEMINI|GOOGLE|GROQ|CEREBRAS|XAI|OPENROUTER|KILO|MISTRAL|ZAI|MINIMAX|OPENCODE|AI_GATEWAY|AZURE|AWS|TAVILY|BRAVE|PERPLEXITY|EXA|FIRECRAWL|TINYFISH|WAIFER|UMANS|UMANS_AI|DEEPSEEK)_?/i
