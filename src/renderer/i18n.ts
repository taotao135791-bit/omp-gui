...
const en = {
  ...
  'chat.suggest.explore.desc': 'Map the architecture and key modules',
  ...
  'chat.suggest.build.desc': 'From idea to a working implementation',
  'chat.suggest.build.prompt': 'I want to build a new feature: ',
  'chat.suggest.review': 'Review code, suggest changes',
  'chat.suggest.review.desc': 'Concrete, actionable improvement ideas',
  ...
  'chat.suggest.fix.desc': 'Hunt down likely bugs and patch them',
  'chat.suggest.fix.prompt': 'Find and fix: ',
...
const zh: Record<I18nKey, string> = {
  ...
  'chat.suggest.explore.desc': '梳理整体架构与关键模块',
  'chat.suggest.explore.prompt': '通读这个项目，向我解释它的整体架构和关键模块。',
  'chat.suggest.build': '构建新功能',
  'chat.suggest.build.desc': '从想法到可用的实现',
  'chat.suggest.build.prompt': '我要做一个新功能：',
  'chat.suggest.review': '审查代码并提出建议',
  'chat.suggest.review.desc': '给出具体可落地的改进意见',
  'chat.suggest.review.prompt': '审查这个项目的代码，提出具体的改进建议。',
  'chat.suggest.fix': '修复问题和失败',
  'chat.suggest.fix.desc': '定位最可能的 bug 并修复',
  'chat.suggest.fix.prompt': '定位并修复：',
