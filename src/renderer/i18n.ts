...
const en = {
  ...
  'settings.authOpenBrowser': 'Open in browser',
  'settings.authPasteKeyHint':
    'If this provider uses an API key instead, paste it below (no browser needed).',
...
const zh: Record<I18nKey, string> = {
  ...
  'settings.authOpenBrowser': '在浏览器中打开',
  'settings.authPasteKeyHint': '如果该 Provider 使用 API Key，请直接粘贴到下方（无需浏览器）。',
