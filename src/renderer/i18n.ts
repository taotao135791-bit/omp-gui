...
const en = {
  ...
  'settings.customProviderModels': 'Models',
  'settings.customProviderModelAdd': 'Add model',
  'settings.customProviderModelIdPlaceholder': 'model-id',
  'settings.customProviderModelNamePlaceholder': 'Display name',
  'settings.customProviderModelContextPlaceholder': 'ctx (optional)',
  'settings.customProviderModelMaxPlaceholder': 'max out (optional)',
  ...
  'settings.customProviderInvalidModels':
    'Add at least one model (id + display name), or enable auto-discovery. Context window / max tokens must be positive integers.',
...
const zh: Record<I18nKey, string> = {
  ...
  'settings.customProviderModels': '模型',
  'settings.customProviderModelAdd': '添加模型',
  'settings.customProviderModelIdPlaceholder': '模型 ID',
  'settings.customProviderModelNamePlaceholder': '显示名',
  'settings.customProviderModelContextPlaceholder': '上下文（可选）',
  'settings.customProviderModelMaxPlaceholder': '最大输出（可选）',
  ...
  'settings.customProviderInvalidModels':
    '请至少添加一个模型（ID + 显示名），或开启自动发现；上下文窗口 / 最大输出必须是正整数。',
